...
// iOS 15-18+, arm64
// Guna rebind_symbols tanpa fishhook.h external —
...
// ══════════════════════════════════════════════════════════════
// MINI FISHHOOK — guna dyld_stub_binder table terus
...
// ══════════════════════════════════════════════════════════════
// HOOK INSTALLER — guna MSHookFunction jika ada,
...
static void hookFunc(const char *sym, void *hook, void **orig) {
    ...
    if (!fn) return;
    *orig = fn;
    // Tukar page protection → writable → tulis branch instruction → restore
